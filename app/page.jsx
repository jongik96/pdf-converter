  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100"> 
      ...
      <section className="max-w-3xl mx-auto mt-16 mb-28 px-4">
        <h2 className="text-xl font-bold mb-6 text-green-800 text-center">ドキュメントキングが特別な理由</h2>
        ...
        <h3 className="font-semibold mb-7 text-green-900 text-2xl text-center">よくある質問</h3>
        <ul className="space-y-8 text-gray-800 font-normal">
            <li>
            <div className="mb-2 text-lg font-bold text-green-800 tracking-tight leading-snug">
            ...
            <div className="text-base md:text-lg leading-relaxed tracking-normal text-gray-800">
                <b className="text-green-700 font-semibold">ドキュメントキング</b>にアップロードされたファイルは変換後1分後に自動削除され、サーバーにも残りません。
      ...
      {/* CTA 배너 */}
      <div className="w-full bg-gradient-to-r from-green-200 to-emerald-200 py-10 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-green-900 mb-4">いつでも無料で変換してください！</h2>
        <a href="#wizard" className="inline-block px-10 py-4 bg-green-700 text-white rounded-2xl font-semibold shadow hover:bg-green-800 transition text-lg">
          ファイル変換すぐに開始 &rarr;
        </a>
