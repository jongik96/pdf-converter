...
export const metadata = {
  ...
  description: "PDFから必要なページのみを素早く抽出！1,2,5-7ページのように自由に指定して新しいPDFとして保存してください。100%無料、会員登録・インストール不要。大きなPDFファイルから必要な部分만 선택して抽出できる無料PDF抽出ツールです。ビジネス文書、レポート、資料作成に最適。",
  keywords: [
    "PDFページ抽出", "PDF一部保存", "PDF希望のページのみ", "PDF抽出ツール", "無料PDF抽出", "文書キング"
  ],
  alternates: {
    canonical: "https://pdfers.com/pdf-extract",
  },
  openGraph: {
    title: "PDFページ抽出 - 希望のページのみ抽出 | 文書キング",
    description: "複雑なPDF文書、必要なページのみを選んで新しいPDFを作成しましょう！国内最強の無料抽出サービス。",
    url: "https://pdfers.com/pdf-extract",
    images: [
